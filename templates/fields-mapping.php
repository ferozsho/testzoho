...
<div class="entry_row">
<div class="entry_col1 vx_label"><label  for="vx_type_<?php echo $k ?>"><?php esc_html_e('Field Type','contact-form-zoho-crm') ?></label></div>
...
<div class="crm_clear"></div> 
  ...
  <input type="text" class="vxc_filter_text" placeholder="<?php esc_html_e('Value','contact-form-zoho-crm') ?>" value="<?php echo $this->post('value',$s_v) ?>" name="meta[filters][<?php echo $filter_k ?>][<?php echo $s_k ?>][value]">
  </div>
  <?php if( $sno_i>1){ ?>
